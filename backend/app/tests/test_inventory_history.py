...
# from app.models import LensesHistory, UpdateField, UpdateType
...
#     history_list = (await test_db_session.scalars(select(LensesHistory))).all()
...
#             select(LensesHistory).where(LensesHistory.update_type != UpdateType.CREATE)
#         )
#     ).all()
...
#     history_list = (
#         await test_db_session.scalars(
#             select(LensesHistory)
#             .where(LensesHistory.update_type == UpdateType.CREATE)
#             .where(LensesHistory.old_value != None)
#         )
#     ).all()
