...
Revision ID: 1f0a574f55f5
Revises: 
Create Date: 2025-04-03 19:33:48.922074-07:00
...
def upgrade():
    ...
    sa.Enum('NAME', 'DESCRIPTION', 'QUANTITY', 'DELETED_AT', name='updatefield').create(op.get_bind())
    ...
    sa.Column('update_field', postgresql.ENUM('NAME', 'DESCRIPTION', 'QUANTITY', 'DELETED_AT', name='updatefield', create_type=False), nullable=False),
...
def downgrade():
    ...
    sa.Enum('NAME', 'DESCRIPTION', 'QUANTITY', 'DELETED_AT', name='updatefield').drop(op.get_bind())
