...
export const LensEdit = () => {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <input type="text" id="id" name="id" defaultValue={record?.id} /> */}
      ...
      <input
        ...
        id="storage_limit"
        name="storage_limit"
        defaultValue={record?.storage_limit}
      />

      <label htmlFor="comment">Comment</label>
      <textarea id="comment" name="comment" defaultValue={record?.comment} />
